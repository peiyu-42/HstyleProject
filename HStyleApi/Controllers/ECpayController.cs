		...
		public void ChekoutByECpay()
		{
			...
			try
			{
				using (AllInOne oPayment = new AllInOne())
				{
					...
					oPayment.Send.ClientBackURL = "http://www.google.com./";//瀏覽器端返回的廠商網址
					oPayment.Send.OrderResultURL = "https://www.youtube.com/";//瀏覽器端回傳付款結果網址
					...
					/* 產生訂單 */
					enErrors.AddRange(oPayment.CheckOut().ErrorList);
				}
			}
			catch (Exception ex)
			{
